...
```
inquire = { version = "0.7.3", features = ["date"] }
```
...
```toml
inquire = { version = "0.7.3", default-features = false, features = ["termion", "date"] }
```

or this:

```toml
inquire = { version = "0.7.3", default-features = false, features = ["console", "date"] }
```
