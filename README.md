...
```
inquire = { version = "0.7.2", features = ["date"] }
```
...
```toml
inquire = { version = "0.7.2", default-features = false, features = ["termion", "date"] }
```

or this:

```toml
inquire = { version = "0.7.2", default-features = false, features = ["console", "date"] }
```
