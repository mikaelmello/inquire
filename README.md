...
```
inquire = { version = "0.8.1", features = ["date"] }
```
...
```toml
inquire = { version = "0.8.1", default-features = false, features = ["termion", "date"] }
```

or this:

```toml
inquire = { version = "0.8.1", default-features = false, features = ["console", "date"] }
```
